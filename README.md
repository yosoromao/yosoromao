...
<!-- 
  这里是一些常用技术的图标，您可以从 https://devicon.dev/ 寻找更多图标。
  只需要替换图标名称即可，例如将 'python-original' 换成 'javascript-original'。
-->
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=cpp,c,java,python,linux,git,vscode&perline=7" />
  </a>
</p>
...
<!--
  这些卡片会自动统计您的 GitHub 数据。
  只需要将 `?username=yosoromao` 中的用户名换成您自己的即可。
  您还可以通过 `&theme=` 参数更换喜欢的主题，例如：dark, radical, merko, gruvbox, tokyonight 等。
-->
<p align-wrap: center; display: flex; flex-direction: column; align-items: center;>
  <!-- GitHub 统计卡片 -->
  <img src="https://github-readme-stats.vercel.app/api?username=yosoromao&show_icons=true&theme=tokyonight&count_private=true&hide_border=true" alt="yosoromao's GitHub stats" width="48%"/>
  <!-- 最常用语言卡片 -->
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=yosoromao&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" width="48%"/>
</p>
...
<!-- 访客数量统计，可选 -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=yosoromao&color=blueviolet" alt="Profile views" />
</p>
